...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IEquipment) => {
    return axios.post<IEquipment>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IEquipment) => {
    return axios.put<IEquipment>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IEquipment) => {
    return axios.patch<IEquipment>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IEquipment>(requestUrl);
  },
  { serializeError: serializeAxiosError },
);
