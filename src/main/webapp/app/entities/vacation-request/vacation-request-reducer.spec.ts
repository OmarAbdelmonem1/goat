...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VACATIONREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VACATIONREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VACATIONREQUEST actions', async () => {
      const arg = { id: 12195 };
    ...
    it('dispatches UPDATE_VACATIONREQUEST actions', async () => {
      const arg = { id: 12195 };
    ...
    it('dispatches PARTIAL_UPDATE_VACATIONREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VACATIONREQUEST actions', async () => {
      const arg = 42666;
