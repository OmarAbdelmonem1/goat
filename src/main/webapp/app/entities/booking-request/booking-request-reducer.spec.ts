...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKINGREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKINGREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKINGREQUEST actions', async () => {
      const arg = { id: 4683 };
    ...
    it('dispatches UPDATE_BOOKINGREQUEST actions', async () => {
      const arg = { id: 4683 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKINGREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKINGREQUEST actions', async () => {
      const arg = 42666;
