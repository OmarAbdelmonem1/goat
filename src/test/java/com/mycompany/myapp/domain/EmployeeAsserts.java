...
public class EmployeeAsserts {
    ...
    public static void assertEmployeeUpdatableFieldsEquals(Employee expected, Employee actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getVacationBalance()).as("check vacationBalance").isEqualTo(expected.getVacationBalance()));
    }
    ...
    public static void assertEmployeeUpdatableRelationshipsEquals(Employee expected, Employee actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getInvitations()).as("check invitations").isEqualTo(expected.getInvitations()));
    }
}
